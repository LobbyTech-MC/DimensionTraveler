...
public class DimensionTraveler extends JavaPlugin implements SlimefunAddon {
    ...
    public void onEnable() {
        ...
        //  Cast Slate
        SlimefunItemStack sfItemCastSlate = new SlimefunItemStack("CAST_SLATE", Material.DRIED_KELP, "&7铸石板", "&6基础材料","&8&ndimension_traveler:cast_slate");
        ...
        //  Dimension Fragments
        SlimefunItemStack sfItemDimensionFragments = new SlimefunItemStack("DIMENSION_FRAGMENTS", Material.PRISMARINE_SHARD, "&9维度碎片", "&6基础材料","&8&ndimension_traveler:dimension_fragments");
        ...
        //  Dimension Gem
        SlimefunItemStack sfItemDimensionGem = new SlimefunItemStack("DIMENSION_GEM", "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvN2I5NTFmZWQ2YTdiMmNiYzIwMzY5MTZkZWM3YTQ2YzRhNTY0ODE1NjRkMTRmOTQ1YjZlYmMwMzM4Mjc2NmQzYiJ9fX0=", "&9维度宝石", "&6基础材料","&8&ndimension_traveler:dimension_gem");
        ...
        //  Thin Cloud
        SlimefunItemStack sfItemThinCloud = new SlimefunItemStack("THIN_CLOUD", Material.WHITE_STAINED_GLASS, "&f轻薄的云", "&6基础材料","&8&ndimension_traveler:thin_cloud");
        ...
        Research research000 =  new Research(beforeEnter, 730516000 , "启程前" , 15 );
        ...
        Research research001 =  new Research(firstEnteringForeignLand, 730516001 , "初入异境" , 20 );
